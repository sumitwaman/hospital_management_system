...
RSpec.describe "Appointments", type: :request do
  ...
  describe 'GET index' do
    before do
      get patient_appointments_path(valid_patient)
    end
  ...
  describe 'GET show' do
    before do
      get patient_appointment_path(valid_patient, @appointment.id)
    end
  ...
  describe 'GET edit' do
    before do
      get edit_patient_appointment_path(valid_patient, @appointment)
    end
  ...
  describe 'GET new' do
    before do
      get new_patient_appointment_url(valid_patient)
    end
  ...
  describe 'POST create' do
    context 'when parameters valid' do
      ...
      it 'creates a new appointment' do
        expect {
          post patient_appointments_path(valid_patient), params: { appointment: valid_params_post }
    ...
    context 'when parameters are invalid ' do
      ...
      it 'does not create a new appointment' do
        expect {
          post patient_appointments_path(valid_patient), params: { appointment: invalid_params_post }
  ...
  describe 'PATCH update' do
    context 'when parameters valid' do
      ...
      it 'update an appointment' do
        expect {
          patch patient_appointment_path(valid_patient, @appointment), params: { appointment: valid_params_update }
        }.to change(Appointment, :count).by(0)
      end
      ...
      it 'updates the requested appointment' do
        patch patient_appointment_path(valid_patient, @appointment), params: { appointment: valid_params_update }
        @appointment.reload
        expect(@appointment.doctor_id).to eq(valid_doctor.id)
      end
    ...
    context 'when parameters are invalid ' do
      ...
      it 'does not update an appointment' do
        expect {
          patch patient_appointment_path(valid_patient, @appointment), params: { appointment: invalid_params_update }
        }.to change(Appointment, :count).by(0)
      end
  ...
  describe 'DELETE destroy' do
    it 'deletes the appointment' do
      expect {
        delete patient_appointment_path(valid_patient, @appointment)
      }.to change(Appointment, :count).by(-1)
    end
